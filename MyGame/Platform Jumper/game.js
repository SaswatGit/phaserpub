...
function preload() {
  ...
  this.load.spritesheet('fullscreen', 'assets/zoom.png', {frameWidth: 48, frameHeight: 48});
}
function create() {
  ...
  rightbtn.on("pointerout", function (pointer) {
    rightmove = false;
    leftmove = false;
  ...
  leftbtn.on("pointerout", function (pointer) {
    leftmove = false;
    rightmove = false;
  });
...
function update() {
  ...
  if ((cursors.left.isDown && go == false) || (leftmove == true && go == false)) {
    player.setVelocityX(-260);
    player.anims.play("left", true);
  } else if ((cursors.right.isDown && go == false) || (rightmove == true && go == false)) {
    player.setVelocityX(260);
