...
function gameOver() {
  ...
  if (score > localStorage.getItem("hdhighscore")) {
    hdhighscore = score;
    localStorage.setItem("hdhighscore",hdhighscore);
  }
  highScoreText = this.add.text(100, 400, "High Score: " + localStorage.getItem("hdhighscore"), {
    fontSize: "20px",
  });
}
